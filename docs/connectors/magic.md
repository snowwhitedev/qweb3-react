...
`yarn add @qweb3/magic-connector`
...
```javascript
import { UserRejectedRequestError } from '@qweb3/magic-connector'
...
```javascript
import { FailedVerificationError } from '@qweb3/magic-connector'
...
```javascript
import { MagicLinkRateLimitError } from '@qweb3/magic-connector'
...
```javascript
import { MagicLinkExpiredError } from '@qweb3/magic-connector'
